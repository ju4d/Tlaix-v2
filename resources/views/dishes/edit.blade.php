    ...
    <form method="POST" action="{{ route('dishes.update', $dish->id) }}" class="space-y-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $dish->available ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div id="ingredients-section" class="space-y-4">
                ...
                @endphp
                <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition duration-200 {{ $isSelected ? 'bg-green-50 border-green-200' : '' }}">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                @if($isSelected)
                                    <p class="text-sm text-green-600">✓ Actualmente usado: {{ $quantity }} {{ $ingredient->unit }}</p>
                                @endif
                            </div>
                        </div>
