...
<div class="max-w-4xl">
    <form method="POST" action="{{ route('dishes.store') }}" class="space-y-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="bg-gradient-to-r from-gray-50 to-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        <p class="text-sm text-gray-800 font-medium mb-3">Selecciona los ingredientes necesarios para este platillo</p>
                        ...
                        <div id="availableIngredients" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 max-h-96 overflow-y-auto">
                            ...
                            <div class="ingredient-card bg-white p-3 rounded-lg border-2 border-gray-200 hover:border-green-500 hover:shadow-md cursor-pointer transition-all"
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <p class="text-xs text-gray-500">
                                                <span class="inline-flex items-center px-2 py-0.5 rounded-full bg-gray-100 text-gray-800">{{ $ingredient->category }}</span>
                                            </p>
                                            @endif
                                        </div>
                                    </div>
...
let allIngredientsData = {!! json_encode($ingredients->map(function($ing) {
    return [
        'id' => $ing->id,
        'name' => $ing->name,
        'stock' => $ing->stock,
