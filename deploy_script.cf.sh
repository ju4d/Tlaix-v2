...
# [LEGACY] Script de despliegue para IBM Cloud usando Cloud Foundry
# Este es un script de respaldo del método anterior de despliegue.
# Para el despliegue actual con Code Engine, usa deploy_script.sh
# Asegúrate de tener instalado IBM Cloud CLI

echo "⚠️  AVISO: Este es un script legacy para Cloud Foundry"
echo "Para el despliegue actual con Code Engine, usa ./deploy_script.sh"
